...
public class JobRole implements Comparable<JobRole> {
	...
	public String toString() {
		return "JobRole [id=" + id + ", jobRole=" + jobRole + ", createdOn=" + createdOn + ", updatedOn=" + updatedOn
				+ ", updatedBy=" + updatedBy + ", createdOnFormatted=" + createdOnFormatted + "]";
	}

	@Override
	public int compareTo(JobRole arg0) {
		return this.jobRole.compareToIgnoreCase((arg0.jobRole));
	}
}
